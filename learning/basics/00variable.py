"""Objective to learn about: 
  Done  - In Python we can make same variable name point to different types of objects
  Done  - learn about Type Casting
  Done  - To learn about 'type(Variable_name)' function 
