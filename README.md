...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | -------------- |
| [FL-01 — AI Workflow Audit](./assignments/FL-01-workflow-audit/)       | Map my real workflows and identify where AI should collaborate, delegate, or automate | 🟡 In Progress |
| [FL-02 — Prompting Fundamentals](./assignments/FL-02-prompting/)       | Improve AI interaction on real tasks                                                  | ⬜ Not Started  |
| [FL-03](./assignments/FL-03/)                                          | TBD                                                                                   | ⬜ Not Started  |
| [FL-04 — Ship an Automation Workflow](./assignments/FL-04-automation/) | Turn a real workflow into a working automation                                        | ⬜ Not Started  |
